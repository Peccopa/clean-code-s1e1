...
var editTask=function(){
  ...
  //If class of the parent is .todo-section-edit
  if(containsClass){

    //switch to .todo-section-edit
  ...
  //toggle .todo-section-edit on the parent.
  listItem.classList.toggle("todo-section-edit");
};
